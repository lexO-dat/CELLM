    ...
    >
      <div className="max-w-xs sm:max-w-md lg:max-w-3xl mr-4 sm:mr-8 lg:mr-12">
        <div className="flex items-center gap-2 mb-2">
          <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center animate-pulse">
            <Brain className="w-3 h-3 sm:w-5 sm:h-5 text-white" />
          </div>
          <span className="text-xs sm:text-sm text-gray-500 font-medium">CELLM</span>
          <span className="text-xs text-blue-500 animate-pulse font-medium">thinking{dots}</span>
        </div>
