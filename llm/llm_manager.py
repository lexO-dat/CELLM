...
class DeepSeekLLM:
    ...
    def __init__(self, api_key: str, base_url: str, model: str, temperature: float = 0.3):
        ...
        self.client = httpx.Client(
            ...
            timeout=600.0  # Increased timeout to 10 minutes for reasoning model
        )
    ...
    """Invoke the DeepSeek API with streaming support"""
    ...
    def _non_stream_response(self, payload):
        ...
        # If there's reasoning content, format it with thinking tags for compatibility
